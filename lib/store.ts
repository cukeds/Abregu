...
export type Evaluacion = {
  id: string;
  /** ID of the competition this evaluation refers to. */
  competenciaId: string;
  /** Human‑readable title of the competition; stored for convenience. */
...
export function listCompetencias() {
  return get<Competencia[]>(KEY_COMP, []);
}
...
export function listEvaluaciones() {
  return get<Evaluacion[]>(KEY_EVAL, []);
}

export function saveAuth(v: any) {
  set(KEY_AUTH, v);
}
export function getAuth() {
  return get(KEY_AUTH, null);
}