...
export default function Evaluaciones() {
  ...
  return (
    <main style={{ padding: 20 }}>
      <h2 style={{ fontSize: 24, marginBottom: 12, color: colors.primary }}>Evaluaciones</h2>
      <div style={{ display: "grid", gap: 8 }}>
        {fakeThread.map((m, i) => (
          <div
            key={i}
            style={{
              justifySelf: m.from === "yo" ? "end" : "start",
              background: m.from === "yo" ? colors.primary : colors.secondary,
              color: m.from === "yo" ? colors.accent : "#000",
              padding: "10px 12px",
              borderRadius: 12,
              maxWidth: "80%"
            }}
